    ...
    <div>
      <div className="footer">
        ...
        <div className="foo_container">
          ...
          <ul>
            <li>
            <Link to={'/allrocket'} style={{textDecoration:'none'}}> <a href="">All Rocket </a></Link>
            </li>
            <li>
            <Link to={'/rocket-comparator'} style={{textDecoration:'none'}}><a href="">Rocket comparator</a></Link>
            </li>
